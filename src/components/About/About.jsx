      ...
      <div className="w-full h-screen flex justify-center my-20">
        <div className="w-11/12 flex flex-col justify-center items-center gap-6">
          ...
          <div className="w-full h-full flex flex-col justify-evenly items-center gap-6">
            <h1 className="text-5xl font-medium font-sans">Languages</h1>
            <div className="w-full grid grid-cols-5 gap-6 justify-items-center">
              <img
                src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/i/a55359db-8be9-4150-8c22-c4f54b6dfc96/df1d241-485b9236-f0ac-4804-a77d-6495d852801d.png"
                alt="C"
                className="w-40 h-40 cursor-pointer rounded-xl shadow-xl p-6"
              />

              <img
                src="https://i.pinimg.com/736x/e9/94/61/e99461fdd5b3db8bdb3081d8acf5e524.jpg"
                alt="java"
                className="w-40 h-40 cursor-pointer rounded-xl shadow-xl  p-6"
              />
              ...
              <img
                src="https://developer.android.com/static/images/brand/Android_Robot.png"
                alt="android"
                className="w-40 h-40 cursor-pointer rounded-xl shadow-xl p-6"
              />
              ...
              <img
                ...
                alt="spring boot"
                className="w-40 h-40 cursor-pointer rounded-xl shadow-xl"
              />
