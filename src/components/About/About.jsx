          ...
          <div className="w-full h-full flex flex-col justify-evenly items-center">
            ...
            <div className="w-full grid grid-cols-5 gap-6 justify-items-center mt-5">
              <img
                ...
                alt="C"
                className="w-40 h-40 cursor-pointer rounded-xl shadow-lg shadow-gray-500 p-4"
              />
              ...
              <img
                ...
                alt="android"
                className="w-40 h-40 border-2 cursor-pointer rounded-xl shadow-lg shadow-gray-500 p-4"
              />
              ...
              <img
                ...
                alt="spring boot"
                className="w-40 h-40  cursor-pointer rounded-xl shadow-lg shadow-gray-500"
              />
