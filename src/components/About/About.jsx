...
import "./About.css";
import pic from '../About/photo.jpg';
...
function About() {
  const languages = [
    ...
    { src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1Hk9IpyuR3mmM2WegJxTWsRBTBmQAL4RYOU3_Cr3N2Ezeh8lb3kX9Ooy2stta4HgHr2g&usqp=CAU", alt: "android" },
    ...
    <div className="w-full min-h-screen flex justify-center py-10 px-4">
      <div className="w-full flex flex-col justify-center items-center gap-10">
        <div className="w-full flex flex-col md:flex-row justify-around items-center gap-6">
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-evenly text-center md:text-left gap-4 p-4">
            <h1 className="text-4xl md:text-6xl font-bold">Know Who I Am?</h1>
            <p className="text-base md:text-xl text-justify leading-relaxed">
              ...
              . Currently, I am in my final year. After my graduation, I will
              shift my career into any big technology like{" "}
              <span id="tech" className="text-orange-500 font-medium">
                AI, Cyber Security, DevOps, Data Analytics.
              </span>
            </p>
          </div>
          <img src={pic} alt="my pic" className="max-w-96 h-full rounded-lg shadow-lg" />
        </div>
        <div className="w-full flex flex-col justify-evenly items-center gap-6">
          <h1 className="text-3xl md:text-5xl font-medium">Languages</h1>
          <div className="w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 justify-items-center">
            {languages.map((lang, index) => (
              <img
                ...
                src={lang.src}
                alt={lang.alt}
                className="w-24 h-24 md:w-32 md:h-32 cursor-pointer rounded-xl shadow-xl p-4 bg-white"
              />
            ))}
          </div>
        </div>
