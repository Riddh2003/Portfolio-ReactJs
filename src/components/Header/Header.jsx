        ...
        <header className='top-2 sticky w-full flex justify-center'>
            <nav className='flex justify-center bg-orange-400 shadow-orange-400 shadow-md p-0 w-11/12 rounded'>
                <div className='flex justify-between w-11/12 items-center p-3'>
                    <div>
                        <h1 className='bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent text-3xl font-medium'>Riddh Modi<span className='ml-1 border-r-8 border-gray-900'></span><span className='ml-1 border-r-8 border-gray-700'></span><span className='ml-1 border-r-8 border-gray-500'></span></h1>
                    </div>
                    <div>
